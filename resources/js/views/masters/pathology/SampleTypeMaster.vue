        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        <select class="form-select form-select-sm" v-model="filters.is_active" @change="loadSampleTypes">
                    ...
                    <table class="table table-sm table-bordered table-hover">
                        <thead class="table-light sticky-top">
                            <tr>
                                ...
                                <th style="min-width: 350px;">Sample Type Name</th>
                        ...
                        <tbody>
                            ...
                            <tr v-else v-for="(item, index) in sampleTypes" :key="item.sample_type_id">
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-sm btn-outline-danger" @click="deleteSampleType(item.sample_type_id)" title="Delete">
...
const loadSampleTypes = async () => {
    ...
    try {
        const response = await axios.get('/api/pathology/sample-types', { params: filters.value });
            ...
            sampleTypes.value = paginatedData.data || paginatedData;
            pagination.value = {
        ...
        // Ensure array
        if (!Array.isArray(sampleTypes.value)) {
            sampleTypes.value = [];
        }
    } catch (err) {
...
const saveSampleType = async () => {
    ...
    try {
        if (editMode.value) {
            await axios.put(`/api/pathology/sample-types/${form.value.sample_type_id}`, form.value);
        } else {
